...
const REPLANENDS = [
  { id: 'E1', label: 'E-1 바로 이어서 CTA', desc: 'Figma 구성 그대로. "요금제가 5GX 프라임 플러스에서 베스트 109으로 변경되었어요." → [선택한 요금제 · 베스트 109 · 다시 선택하기] 줄 → 곧바로 [신청서 작성 시작하기]. 군더더기 없이 가장 짧고, 되돌린 뒤 갈 곳이 바로 보인다' },
