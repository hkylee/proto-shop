...
export default function App() {
  ...
  const [dimfxV, setDimfxV] = useState(() => (LAB ? (Q0.get('df') || 'G2') : CONFIRMED.dimfx))
    ...
    <>
      ...
      {LAB && (
        <div className="lab-groups">
          ...
          <div className="variants">
            <b className="vtitle">2·3안 · 모달 뒤 딤 (아무 모달 스텝에서나)</b>
            {DIMFXS.map((v) => (
