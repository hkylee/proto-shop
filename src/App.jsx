      ...
      {LAB && (
        <div className="lab-groups">
          ...
          <div className="variants v-stackgap">
            <b className="vtitle">시안 1-1 · 스택 여백 통일 — 미확정</b>
            {STACKGAPS.map((v) => (
