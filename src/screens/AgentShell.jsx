...
/* 컨텍스트 헤더의 단계 목록. 앞 6개는 상품 상세에서 고른 것, 7부터가 Agent 안에서 고르는 것.
   2026-09-15: 할인 방법 뒤에 '추가 혜택' 이 새로 앞으로 오고 마지막 옵션이 '기프트' 가 되면서 19 → 20 단계 */
export const OPTIONS = ['색상', '용량', '수령 방법', '납부 기간', '사용자', '가입 유형', '요금제', '할인 방법', '추가 혜택', '추가 할인 수단', '쿠폰', '결제 방법', '기프트', '주민등록번호', '주소', '본인 인증', '신원 인증', '납부 수단', '요금안내서', '결제']
