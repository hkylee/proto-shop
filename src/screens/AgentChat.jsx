...
const DISC_MSG = <>할인 방법에 따라 휴대폰 가격과 월 통신요금에서 받을 수 있는 할인 금액이 달라져요.<br />비교해보고 할인 방법을 선택해주세요.</>   // 두 줄 (사용자 2026-09-16)   // 사용자 2026-09-16 (이전: '공통지원금으로 할인 받으시는걸 추천드려요. 24개월동안…')
const DISC_LIST = [
