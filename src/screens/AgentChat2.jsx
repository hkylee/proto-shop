...
const TURNS = [
  ...
  { id: 'coupon',  k: 10, label: '쿠폰',          msgs: ['보유하신 쿠폰 중에서는 50,000원 할인 쿠폰이 가장 혜택이 커요. 이 쿠폰으로 적용해드릴까요?'],   // 쿠폰 답은 별도 말풍선 (사용자 2026-09-16 저녁, 오후의 merge 되돌림 — merge: true 로 다시 합칠 수 있다)
